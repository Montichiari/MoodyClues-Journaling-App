...
const TopBarC = ({ rangeDays, onChangeRange }) => {
        ...
        <div className="border-b px-5 pt-4 pb-3 border-stone-200 mb-4">
            <div className="flex items-center justify-between gap-3">
                ...
                <Button
                    ...
                    sx={{ textTransform: "none", fontSize: "0.95rem", px: 1.5, py: 0.75, borderRadius: 2 }}
                >
                    {selected.label}
                </Button>
                <Menu
                ...
                >
                    {OPTIONS.map(o => (
                        <MenuItem key={o.value} selected={o.value === rangeDays}
